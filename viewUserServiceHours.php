...
$sql="SELECT  service.scout_id, scouts.first, scouts.last, service.date, service.hours, service.description FROM service INNER JOIN scouts ON service.scout_id = scouts.id WHERE id LIKE '$id'";
